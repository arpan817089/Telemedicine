...
if (isset($_POST['submit'])) {
	...
	if ($conn->connect_error) {
		...
		$stmt = $conn->prepare("insert into pat_reg_no(pat1,pat2,pat3,pat4,pat5,add_pat1,add_pat2,add_pat3,add_pat4,add_pat5,add_pat6,Family_Registration_No) values(?,?, ?, ?, ?,?,?,?, ?, ?,?,?)");
		$stmt->bind_param("ssssssssssss", $pat1, $pat2, $pat3, $pat4, $pat5, $add_pat1, $add_pat2, $add_pat3, $add_pat4, $add_pat5, $add_pat6, $Family_Registration_No);
