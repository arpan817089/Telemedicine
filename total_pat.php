...
.hindi {
    ...
    <section class="home-section">
        <div class="text">Patient Details</div>
        <!-- <div style="padding: 10px 10px; background-color: lightgreen">
            <h2>Welcome Dr. <?php echo "$nm  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp SSF-Id:$res[1]"; ?></h2>
        </div> -->
        ...
        <div><br>
            <div class="row">
                <div class="column">
                    <table>
                        ...
                        ?>
                            <tr><?php $arr_ind++; ?>
                                ...
                                <td><?php echo $r['per_reg'] ?></td>
                                <td><?php echo $r['pm_his'] ?></td>
                                ...
                                <!-- <td> <?php echo $r['Name'] ?> </td>
                                <td>Chandpur</td> -->
                                <td><a href="details_pat.php?x=<?php echo $r['per_reg']; ?>">Details</a></td>
                                <td><a href="PRESCRIPTION2.php?x=<?php echo $r['name']; ?>"><img src="pdf.png" width = 50px height = 50px></a></td>
                            </tr>
                        <?php
                        }
                    ...
                    $st_date = date('Y-m-d'); ?>
                    <button type="submit" id="but1" style="height:20px;padding-bottom:2rem;width:100px;margin-top:2rem;margin-left: 50rem;" class="btn-wide btn btn-success"><a style="color: white;" href="DASHBOARD.php?from=<?php echo $st_date ?>&to=<?php echo $st_date ?>">Back</a></button>
                </div>
