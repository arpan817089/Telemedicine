...
if (isset($_SESSION['dcr'])) {
    ...
    // $fetch = mysqli_fetch_row($pat_name);
    //echo $name_1;
}
        ...
        <div><br>
            <div class="row">
                <div class="column">
                    ...
                    $st_date = date('Y-m-d'); ?>
                    <a style="color: white;" href="doc_dash2.php"><button type="submit" id="but1" style="height:20px;padding-bottom:2rem;width:100px;margin-top:2rem;margin-left: 50rem;" class="btn-wide btn btn-success">Back</button></a>
                </div>
