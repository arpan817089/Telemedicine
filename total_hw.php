                ...
                <div class="column">
                    <table>
                        ...
                        <tr>
                            ...
                            <th>Health Worker User ID</th>
                            <th>Health Worker Password</th>
                        </tr>
                        <?php $num = 1;  ?>
                        <?php $arr_ind = 0;  ?>
                        <?php $nume_pat_arr = [] ?>
                    ...
                    $st_date = date('Y-m-d'); ?>
                    <button type="submit" id="but1" style="height:20px;padding-bottom:2rem;width:100px;margin-top:2rem;margin-left: 50rem;" class="btn-wide btn btn-success"><a style="color: white;" href="admin.php">Back</a></button>
                </div>
