...
<?php } ?>
<?php $num_hw2 = 0; ?>
<?php while ($r = mysqli_fetch_array($hw2)) {
    $num_hw2++;
?>
<?php } ?>
                        ...
                        <div class="widget-content p-0">
                            <div class="widget-content-wrapper">
                                <div class="widget-content-left">
                                    ...
                                    <a class="fa fa-sign-out" style="font-size:45px;color:red;" href="admin_login.php"></a>
                                    </button>
                                <!--</div>-->
                            ...
                            <div class="card mb-3 widget-content bg-midnight-bloom">
                                <div class="widget-content-wrapper text-white">
                                    ...
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-white"><a href="total_hw.php" style="color:white;cursor:pointer;"><?php echo $num_hw2; ?></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-6">
                            <div class="card mb-3 widget-content bg-arielle-smile">
                                <div class="widget-content-wrapper text-white">
                                    ...
                                    <div class="widget-content-right">
                                        <div class="widget-numbers text-white"><a href="total_doc2.php" style="color:white;cursor:pointer;"><?php echo $num_doc; ?></a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
