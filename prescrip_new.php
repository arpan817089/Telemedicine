...
<body>
    ...
    <div class="col-sm-12 form-group"> <select id="choices-multiple-remove-button" placeholder="Doses" >
    
    <option style="background-image:url('Logo.png');" value="HTML">o|&nbsp;&nbsp;||&nbsp;&nbsp;o|&nbsp;&nbsp;|| &nbsp;&nbsp;o|</option>        
    <option style="background-image:url(Logo.png);" value="HTML">|o&nbsp;&nbsp;||&nbsp;&nbsp;|o&nbsp;&nbsp;|| &nbsp;&nbsp;|o<b></option>
    <option style="background-image:url(Logo.png);" value="HTML">|&nbsp;&nbsp;||&nbsp;&nbsp;|&nbsp;&nbsp;|| &nbsp;&nbsp;|o</option>
    <option style="background-image:url(Logo.png);" value="HTML">|&nbsp;&nbsp;||&nbsp;&nbsp;|&nbsp;&nbsp;|| &nbsp;&nbsp;o|</option>
    <option style="background-image:url(Logo.png);" value="HTML">o|&nbsp;&nbsp;||&nbsp;&nbsp;|o&nbsp;&nbsp;|| &nbsp;&nbsp;|o</option>        
    <option style="background-image:url(Logo.png);" value="HTML">|&nbsp;&nbsp;||&nbsp;&nbsp;|o&nbsp;&nbsp;|| &nbsp;&nbsp;|o<b></option>
    <option style="background-image:url(Logo.png);" value="HTML">o|&nbsp;&nbsp;||&nbsp;&nbsp;o|&nbsp;&nbsp;|| &nbsp;&nbsp;|</option>
    <option style="background-image:url(Logo.png);" value="HTML">o|&nbsp;&nbsp;||&nbsp;&nbsp;o|&nbsp;&nbsp;|| &nbsp;&nbsp;|o</option>        
    <!-- <option style="background-image:url(Logo.png);" value="HTML">x&nbsp;&nbsp;| O |&nbsp;&nbsp;o<b></option> -->
