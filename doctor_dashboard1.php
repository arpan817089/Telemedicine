...
$q3 = "SELECT * FROM `medical_consultant` where `Assigned_doctor` = '$nm' and `Consultation_Date` = '$date'";
...
<?php $num = 0; ?>
                    ...
                    <table style="margin-left:3rem;">
                        ...
                        <tr>
                            <td><input style="border:none;outline:none; font-size: 2rem;padding-left:6rem;" type="date" id="date" value="<?php echo $date;$_SESSION['date'] = $date?>" readonly="readonly" ></td>
                            <td><input style="border:none;outline:none; font-size: 2rem; padding-left:5rem;" type="text" id="time" value="" readonly="readonly"></td>
                            <td style="padding-left:2rem; font-size: 2rem;"><?php echo $num; ?></td>
                            <!--<td style="padding-left:8rem; font-size: 2rem;"> Chandpur</td>-->
                            <td style="padding-left:8rem;"><a href="view_dashboard.php"><button type="submit" style="width: 7rem; text-align:center; font-size:1.2rem; height:3rem" class="btn btn-success btn-sm">View</td></a>
                        </tr>
                    </table>
                </div>
